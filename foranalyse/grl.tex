...
Udregning af trafikprognose er det samme som i afsnit \ref{sec:prognose}. Busy-hour trafik prognosen for Kullorsuaq fra 2017 til 2022 ses på figur \ref{fig:kapBehovKullorsuaq}.
\begin{figure}[!h]
	\centering
...
%\section{Afgrænsning}\label{sec:afgrænsning}
%I denne kapitel gennemgås afgrænsningen for projektet. Afgrænsningerne danner rammerne for løsningsforslaget for mobile last mile projektet.\\
%
%Der afgrænses fra følgende:
%\begin{itemize}
%	\item 
%\end{itemize}